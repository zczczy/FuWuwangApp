 ...
 *
 * Special TabHost that allows the use of {@link Fragment} objects for its tab_add
 ...
 * initialization of the tab_add host.
 *
 * <p>
...
public class FragmentTabHost extends TabHost
    ...
    public void addTab(TabSpec tabSpec, Class<?> clss, Bundle args) {
        ...
        if (mAttached) {
            ...
            // sure this tab_add's fragment is inactive if it exists.  This shouldn't
            // normally happen.
            info.fragment = mFragmentManager.findFragmentByTag(tag);
            if (info.fragment != null && !info.fragment.isDetached()) {
                FragmentTransaction ft = mFragmentManager.beginTransaction();
                // ft.detach(info.fragment);  修改重复创建fragment
        ...
        for (int i=0; i<mTabs.size(); i++) {
            ...
            if (tab.fragment != null) {
                if (tab.tag.equals(currentTab)) {
                    // The fragment for this tab_add is already there and
                    ...
                    // ft.detach(tab_add.fragment);  修改重复创建fragment
...
//        if (newTab == null) {
//            throw new IllegalStateException("No tab_add known for tag " + tabId);
//        }
        if (mLastTab != newTab) {
            if (ft == null) {
                ft = mFragmentManager.beginTransaction();
            ...
            if (newTab != null) {
                if (newTab.fragment == null) {
                    ...
                    //ft.attach(newTab.fragment); 修改重复创建fragment
