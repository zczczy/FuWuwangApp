...
/**
 * 体验中心列表
 * Created by chunyu on 2015/6/30.
 */
public class Experience {
   ...
   public String imgurl;
    ...
    public void setAbcreatedate(BigDecimal abcreatedate) {
    ...
    public void setIsjty(Integer isjty) {
        this.isjty = isjty;
    }

    public Integer getShifouxianshi() {
        return shifouxianshi;
    }

    public void setShifouxianshi(Integer shifouxianshi) {
        this.shifouxianshi = shifouxianshi;
    }
