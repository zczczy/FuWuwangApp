...
import com.zczczy.leo.fuwuwangapp.items.InformationItemView_;
 ...
 */
@EBean
public class InformationAdapter extends BaseUltimateRecyclerViewAdapter<Information> {
    ...
    public void getMoreData(int pageIndex, int pageSize, boolean isRefresh, Object... objects) {
        ...
        afterGetData(myRestClient.GetInformationList(pageIndex, pageSize));
    }

    @UiThread
    void afterGetData(BaseModelJson<PagerResult<Information>> bmj) {
        if (bmj == null) {
...
//            AndroidTool.showToast(context, no_net);
    ...
    protected View onCreateItemView(ViewGroup parent) {
        return InformationItemView_.build(parent.getContext());
    }
