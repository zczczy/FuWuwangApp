...
public class RegexUtils {
    ...
    /**
     * 匹配手机号码的正则表达式
     * <br>支持130——139、150——153、155——159、180、182、183、185、186、187、188、189号段
     */
    public static final String PHONE_NUMBER_REGEX = "^1(3[0-9]|4[57]|5[0-35-9]|8[0-9]|70)\\\\d{8}$";
